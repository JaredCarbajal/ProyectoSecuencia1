...
try {
    ...
    $sentencia = $conex->prepare("INSERT INTO Empleados(id, nombre, apellido, domicilio, correo, telefono, edad) VALUES (:id, :nombre, :apellido, :domicilio, :correo, :telefono, :edad);");
